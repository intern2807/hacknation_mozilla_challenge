...
on run
    ...
    if button returned of dialogResult is "Uninstall" then
        ...
        try
            ...
            -- Show success
            display dialog "Harbor has been uninstalled successfully!" & return & return & "To complete the removal:" & return & "1. Open Firefox" & return & "2. Go to about:addons" & return & "3. Find 'Harbor' and click Remove" buttons {"OK"} default button "OK" with title "Uninstall Complete" with icon note
